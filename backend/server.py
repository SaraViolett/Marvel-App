...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:leaRning1!@localhost/marvel'
...
def create_database():
    root_engine = create_engine("mysql+mysqlconnector://root:leaRning1!@localhost")  # No database specified
